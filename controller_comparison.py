...
car_mpc = Car(50, 50)
car_pid = Car(50, 50)
controller_pid = PID(kp_linear = 0.5, kd_linear = 0.1, ki_linear = 0, kp_angular = 3, kd_angular = 0.1, ki_angular = 0)
horizon = 5
...
while True:
    ...
    if len(mpc_car_points) > 0:
        draw.draw_path(mpc_car_points, color = (0, 255, 0), thickness = 1, dotted = False)
